...
poetry run convert -f ${PELE_PHYSICS_HOME}/Support/Mechanism/Models/dodecane_lu_qss/qssa.yaml --hformat gpu --remove_1 --remove_pow  --min_op_count 3 --recursive_op_count --store_in_jacobian --round_decimals
