...
static double troe_a_DEF[27], troe_Ts_DEF[27], troe_Tss_DEF[27],
  troe_Tsss_DEF[27];
static double sri_a_DEF[27], sri_b_DEF[27], sri_c_DEF[27], sri_d_DEF[27],
  sri_e_DEF[27];
static double activation_units_DEF[27], prefactor_units_DEF[27],
  phase_units_DEF[27];
static int is_PD_DEF[27], troe_len_DEF[27], sri_len_DEF[27], nTB_DEF[27],
  *TBid_DEF[27];
static double* TB_DEF[27];
static int rxn_map[27] = {6, 7,  8,  9,  10, 2,  11, 12, 3,  13, 14, 4,  5, 15,
                          0, 16, 17, 18, 19, 20, 21, 1,  22, 23, 24, 25, 26};
...
CKINIT()
{
  ...
  TB[2][1] = 12; // H2O
  TBid[2][2] = 11;
  TB[2][2] = 1.8999999999999999; // CO
  TBid[2][3] = 12;
  TB[2][3] = 3.7999999999999998; // CO2
  TBid[2][4] = 9;
  TB[2][4] = 0; // AR
  TBid[2][5] = 10;
  TB[2][5] = 0; // HE
  ...
  TB[3][3] = 0; // HE
  TBid[3][4] = 11;
  TB[3][4] = 1.8999999999999999; // CO
  TBid[3][5] = 12;
  TB[3][5] = 3.7999999999999998; // CO2
  ...
  TB[4][3] = 0.75; // HE
  TBid[4][4] = 11;
  TB[4][4] = 1.8999999999999999; // CO
  TBid[4][5] = 12;
  TB[4][5] = 3.7999999999999998; // CO2
  ...
  TB[5][4] = 1.5; // O2
  TBid[5][5] = 11;
  TB[5][5] = 1.8999999999999999; // CO
  TBid[5][6] = 12;
  TB[5][6] = 3.7999999999999998; // CO2
  ...
  TBid[0][3] = 11;
  TB[0][3] = 1.8999999999999999; // CO
  TBid[0][4] = 12;
  TB[0][4] = 3.7999999999999998; // CO2
  TBid[0][5] = 9;
  TB[0][5] = 0.67000000000000004; // AR
  TBid[0][6] = 10;
  TB[0][6] = 0.80000000000000004; // HE
  ...
  TB[1][0] = 7.5; // H2O
  TBid[1][1] = 12;
  TB[1][1] = 1.6000000000000001; // CO2
  TBid[1][2] = 8;
  TB[1][2] = 1.5; // N2
  TBid[1][3] = 5;
  TB[1][3] = 1.2; // O2
  TBid[1][4] = 10;
  TB[1][4] = 0.65000000000000002; // HE
  TBid[1][5] = 7;
  TB[1][5] = 7.7000000000000002; // H2O2
  TBid[1][6] = 1;
  TB[1][6] = 3.7000000000000002; // H2
  TBid[1][7] = 11;
  TB[1][7] = 2.7999999999999998; // CO
...
comp_qfqr(double* qf, double* qr, double* sc, double* tc, double invT)
{
  ...
  /* troe */
  {
    ...
    alpha[0] = mixture + (TB[0][0] - 1) * sc[1] + (TB[0][1] - 1) * sc[4] +
               (TB[0][2] - 1) * sc[5] + (TB[0][3] - 1) * sc[11] +
               (TB[0][4] - 1) * sc[12] + (TB[0][5] - 1) * sc[9] +
               (TB[0][6] - 1) * sc[10];
    alpha[1] = mixture + (TB[1][0] - 1) * sc[4] + (TB[1][1] - 1) * sc[12] +
               (TB[1][2] - 1) * sc[8] + (TB[1][3] - 1) * sc[5] +
               (TB[1][4] - 1) * sc[10] + (TB[1][5] - 1) * sc[7] +
               (TB[1][6] - 1) * sc[1] + (TB[1][7] - 1) * sc[11];
    for (int i = 0; i < 2; i++) {
...
#pragma simd
  ...
  for (int i = 0; i < npt; i++) {
    ...
    alpha =
      ...
      (TB[0][5] - 1) * sc[9 * npt + i] + (TB[0][6] - 1) * sc[10 * npt + i];
    k_f = k_f_s[0 * npt + i];
    ...
    phi_f = sc[7 * npt + i];
    alpha =
      mixture[i] + (TB[1][0] - 1) * sc[4 * npt + i] +
      (TB[1][1] - 1) * sc[12 * npt + i] + (TB[1][2] - 1) * sc[8 * npt + i] +
      (TB[1][3] - 1) * sc[5 * npt + i] + (TB[1][4] - 1) * sc[10 * npt + i] +
      (TB[1][5] - 1) * sc[7 * npt + i] + (TB[1][6] - 1) * sc[1 * npt + i] +
      (TB[1][7] - 1) * sc[11 * npt + i];
    k_f = k_f_s[1 * npt + i];
    ...
    phi_f = sc[1 * npt + i];
    alpha =
      mixture[i] + (TB[2][0] - 1) * sc[1 * npt + i] +
      (TB[2][1] - 1) * sc[4 * npt + i] + (TB[2][2] - 1) * sc[11 * npt + i] +
      (TB[2][3] - 1) * sc[12 * npt + i] + (TB[2][4] - 1) * sc[9 * npt + i] +
      (TB[2][5] - 1) * sc[10 * npt + i];
    ...
    alpha =
      mixture[i] + (TB[3][0] - 1) * sc[1 * npt + i] +
      (TB[3][1] - 1) * sc[4 * npt + i] + (TB[3][2] - 1) * sc[9 * npt + i] +
      (TB[3][3] - 1) * sc[10 * npt + i] + (TB[3][4] - 1) * sc[11 * npt + i] +
      (TB[3][5] - 1) * sc[12 * npt + i];
    ...
    alpha =
      mixture[i] + (TB[4][0] - 1) * sc[1 * npt + i] +
      (TB[4][1] - 1) * sc[4 * npt + i] + (TB[4][2] - 1) * sc[9 * npt + i] +
      (TB[4][3] - 1) * sc[10 * npt + i] + (TB[4][4] - 1) * sc[11 * npt + i] +
      (TB[4][5] - 1) * sc[12 * npt + i];
    ...
    phi_f = sc[4 * npt + i];
    alpha =
      mixture[i] + (TB[5][0] - 1) * sc[1 * npt + i] +
      (TB[5][1] - 1) * sc[4 * npt + i] + (TB[5][2] - 1) * sc[10 * npt + i] +
      (TB[5][3] - 1) * sc[8 * npt + i] + (TB[5][4] - 1) * sc[5 * npt + i] +
      (TB[5][5] - 1) * sc[11 * npt + i] + (TB[5][6] - 1) * sc[12 * npt + i];
...
aJacobian(double* J, double* sc, double T, int consP)
{
  ...
  /* also 3-body */
  /* 3-body correction factor */
  alpha = mixture + (TB[1][0] - 1) * sc[4] + (TB[1][1] - 1) * sc[12] +
          (TB[1][2] - 1) * sc[8] + (TB[1][3] - 1) * sc[5] +
          (TB[1][4] - 1) * sc[10] + (TB[1][5] - 1) * sc[7] +
          (TB[1][6] - 1) * sc[1] + (TB[1][7] - 1) * sc[11];
  /* forward */
...
dcvpRdT(double* species, double* tc)
{
  ...
  if (T < 1000) {
    ...
    species[10] = +0.00000000e+00 + 0.00000000e+00 * tc[1] +
                  0.00000000e+00 * tc[2] + 0.00000000e+00 * tc[3];
    /*species 11: CO */
    species[11] = +1.51194100e-03 - 7.76351000e-06 * tc[1] +
                  1.67458320e-08 * tc[2] - 9.89980400e-12 * tc[3];
    /*species 12: CO2 */
    species[12] = +9.92207200e-03 - 2.08182200e-05 * tc[1] +
    ...
    species[10] = +0.00000000e+00 + 0.00000000e+00 * tc[1] +
                  0.00000000e+00 * tc[2] + 0.00000000e+00 * tc[3];
    /*species 11: CO */
    species[11] = +1.44268900e-03 - 1.12616560e-06 * tc[1] +
                  3.05574300e-10 * tc[2] - 2.76438080e-14 * tc[3];
    /*species 12: CO2 */
    species[12] = +3.14016900e-03 - 2.55682200e-06 * tc[1] +
...
gibbs(double* species, double* tc)
{
  ...
  if (T < 1000) {
    ...
    /*species 11: CO */
    species[11] = -1.431054000000000e+04 * invT - 1.586445000000000e+00 -
    ...
    /*species 12: CO2 */
    species[12] = -4.837314000000000e+04 * invT - 7.912765000000000e+00 -
    ...
    species[10] = -7.453750000000000e+02 * invT + 1.584651100000000e+00 -
                  ...
                  0.000000000000000e+00 * tc[3] - 0.000000000000000e+00 * tc[4];
    /*species 11: CO */
    species[11] = -1.426835000000000e+04 * invT - 3.083140000000000e+00 -
    ...
    /*species 12: CO2 */
    species[12] = -4.896696000000000e+04 * invT + 5.409018900000000e+00 -
...
helmholtz(double* species, double* tc)
{
  ...
  if (T < 1000) {
    ...
    species[10] = -7.45375000e+02 * invT + 5.84651200e-01 -
                  ...
                  0.00000000e+00 * tc[4];
    /*species 11: CO */
    species[11] = -1.43105400e+04 * invT - 2.58644500e+00 -
                  3.26245200e+00 * tc[0] - 7.55970500e-04 * tc[1] +
                  6.46959167e-07 * tc[2] - 4.65162000e-10 * tc[3] +
                  1.23747550e-13 * tc[4];
    /*species 12: CO2 */
    species[12] = -4.83731400e+04 * invT - 8.91276500e+00 -
    ...
    species[10] = -7.45375000e+02 * invT + 5.84651100e-01 -
                  ...
                  0.00000000e+00 * tc[4];
    /*species 11: CO */
    species[11] = -1.42683500e+04 * invT - 4.08314000e+00 -
                  3.02507800e+00 * tc[0] - 7.21344500e-04 * tc[1] +
                  9.38471333e-08 * tc[2] - 8.48817500e-12 * tc[3] +
                  3.45547600e-16 * tc[4];
    /*species 12: CO2 */
    species[12] = -4.89669600e+04 * invT + 4.40901890e+00 -
...
cv_R(double* species, double* tc)
{
  ...
  if (T < 1000) {
    ...
    species[10] = +1.50000000e+00 + 0.00000000e+00 * tc[1] +
                  ...
                  0.00000000e+00 * tc[4];
    /*species 11: CO */
    species[11] = +2.26245200e+00 + 1.51194100e-03 * tc[1] -
                  3.88175500e-06 * tc[2] + 5.58194400e-09 * tc[3] -
                  2.47495100e-12 * tc[4];
    /*species 12: CO2 */
    species[12] = +1.27572500e+00 + 9.92207200e-03 * tc[1] -
    ...
    species[10] = +1.50000000e+00 + 0.00000000e+00 * tc[1] +
                  ...
                  0.00000000e+00 * tc[4];
    /*species 11: CO */
    species[11] = +2.02507800e+00 + 1.44268900e-03 * tc[1] -
                  5.63082800e-07 * tc[2] + 1.01858100e-10 * tc[3] -
                  6.91095200e-15 * tc[4];
    /*species 12: CO2 */
    species[12] = +3.45362300e+00 + 3.14016900e-03 * tc[1] -
...
cp_R(double* species, double* tc)
{
  ...
  if (T < 1000) {
    ...
    species[10] = +2.50000000e+00 + 0.00000000e+00 * tc[1] +
                  ...
                  0.00000000e+00 * tc[4];
    /*species 11: CO */
    species[11] = +3.26245200e+00 + 1.51194100e-03 * tc[1] -
                  3.88175500e-06 * tc[2] + 5.58194400e-09 * tc[3] -
                  2.47495100e-12 * tc[4];
    /*species 12: CO2 */
    species[12] = +2.27572500e+00 + 9.92207200e-03 * tc[1] -
                  1.04091100e-05 * tc[2] + 6.86668700e-09 * tc[3] -
                  2.11728000e-12 * tc[4];
  } else {
    /*species 0: H */
    ...
    species[10] = +2.50000000e+00 + 0.00000000e+00 * tc[1] +
                  ...
                  0.00000000e+00 * tc[4];
    /*species 11: CO */
    species[11] = +3.02507800e+00 + 1.44268900e-03 * tc[1] -
                  5.63082800e-07 * tc[2] + 1.01858100e-10 * tc[3] -
                  6.91095200e-15 * tc[4];
    /*species 12: CO2 */
    species[12] = +4.45362300e+00 + 3.14016900e-03 * tc[1] -
                  1.27841100e-06 * tc[2] + 2.39399700e-10 * tc[3] -
                  1.66903300e-14 * tc[4];
  }
  return;
...
speciesInternalEnergy(double* species, double* tc)
{
  ...
  if (T < 1000) {
    ...
    species[10] = +1.50000000e+00 + 0.00000000e+00 * tc[1] +
                  ...
                  0.00000000e+00 * tc[4] - 7.45375000e+02 * invT;
    /*species 11: CO */
    species[11] = +2.26245200e+00 + 7.55970500e-04 * tc[1] -
                  1.29391833e-06 * tc[2] + 1.39548600e-09 * tc[3] -
                  4.94990200e-13 * tc[4] - 1.43105400e+04 * invT;
    /*species 12: CO2 */
    species[12] = +1.27572500e+00 + 4.96103600e-03 * tc[1] -
    ...
    species[10] = +1.50000000e+00 + 0.00000000e+00 * tc[1] +
                  ...
                  0.00000000e+00 * tc[4] - 7.45375000e+02 * invT;
    /*species 11: CO */
    species[11] = +2.02507800e+00 + 7.21344500e-04 * tc[1] -
                  1.87694267e-07 * tc[2] + 2.54645250e-11 * tc[3] -
                  1.38219040e-15 * tc[4] - 1.42683500e+04 * invT;
    /*species 12: CO2 */
    species[12] = +3.45362300e+00 + 1.57008450e-03 * tc[1] -
...
speciesEnthalpy(double* species, double* tc)
{
  ...
  if (T < 1000) {
    ...
    species[10] = +2.50000000e+00 + 0.00000000e+00 * tc[1] +
                  ...
                  0.00000000e+00 * tc[4] - 7.45375000e+02 * invT;
    /*species 11: CO */
    species[11] = +3.26245200e+00 + 7.55970500e-04 * tc[1] -
                  1.29391833e-06 * tc[2] + 1.39548600e-09 * tc[3] -
                  4.94990200e-13 * tc[4] - 1.43105400e+04 * invT;
    /*species 12: CO2 */
    species[12] = +2.27572500e+00 + 4.96103600e-03 * tc[1] -
                  3.46970333e-06 * tc[2] + 1.71667175e-09 * tc[3] -
                  4.23456000e-13 * tc[4] - 4.83731400e+04 * invT;
  } else {
    /*species 0: H */
    ...
    species[10] = +2.50000000e+00 + 0.00000000e+00 * tc[1] +
                  ...
                  0.00000000e+00 * tc[4] - 7.45375000e+02 * invT;
    /*species 11: CO */
    species[11] = +3.02507800e+00 + 7.21344500e-04 * tc[1] -
                  1.87694267e-07 * tc[2] + 2.54645250e-11 * tc[3] -
                  1.38219040e-15 * tc[4] - 1.42683500e+04 * invT;
    /*species 12: CO2 */
    species[12] = +4.45362300e+00 + 1.57008450e-03 * tc[1] -
                  4.26137000e-07 * tc[2] + 5.98499250e-11 * tc[3] -
                  3.33806600e-15 * tc[4] - 4.89669600e+04 * invT;
  }
  return;
...
speciesEntropy(double* species, double* tc)
{
  ...
  if (T < 1000) {
    ...
    /*species 11: CO */
    species[11] = +3.26245200e+00 * tc[0] + 1.51194100e-03 * tc[1] -
                  1.94087750e-06 * tc[2] + 1.86064800e-09 * tc[3] -
                  6.18737750e-13 * tc[4] + 4.84889700e+00;
    /*species 12: CO2 */
    species[12] = +2.27572500e+00 * tc[0] + 9.92207200e-03 * tc[1] -
    ...
    /*species 11: CO */
    species[11] = +3.02507800e+00 * tc[0] + 1.44268900e-03 * tc[1] -
                  2.81541400e-07 * tc[2] + 3.39527000e-11 * tc[3] -
                  1.72773800e-15 * tc[4] + 6.10821800e+00;
    /*species 12: CO2 */
    species[12] = +4.45362300e+00 * tc[0] + 3.14016900e-03 * tc[1] -
