...
void
VCKYTX(int* np, amrex::Real* y, amrex::Real* x)
{
  amrex::Real YOW[*np];
  amrex::Real imw[21];
...
void
VCKHMS(int* np, amrex::Real* T, amrex::Real* hms)
{
...
void
VCKWYR(
  int* np, amrex::Real* rho, amrex::Real* T, amrex::Real* y, amrex::Real* wdot)
{
...
/*Compute P = rhoRT/W(y) */
void
VCKPY(int* np, amrex::Real* rho, amrex::Real* T, amrex::Real* y, amrex::Real* P)
{
  amrex::Real YOW[*np];
  amrex::Real imw[21];
...
void
vproductionRate(int npt, amrex::Real* wdot, amrex::Real* sc, amrex::Real* T)
{
...
void
vcomp_k_f(int npt, amrex::Real* k_f_s, amrex::Real* tc, amrex::Real* invT)
{
  for (int i = 0; i < npt; i++) {
    k_f_s[0 * npt + i] =
    ...
    k_f_s[29 * npt + i] =
      prefactor_units[29] * fwd_A[29] *
      exp(fwd_beta[29] * tc[i] - activation_units[29] * fwd_Ea[29] * invT[i]);
    k_f_s[30 * npt + i] =
      prefactor_units[30] * fwd_A[30] *
      exp(fwd_beta[30] * tc[i] - activation_units[30] * fwd_Ea[30] * invT[i]);
    k_f_s[31 * npt + i] =
      prefactor_units[31] * fwd_A[31] *
      exp(fwd_beta[31] * tc[i] - activation_units[31] * fwd_Ea[31] * invT[i]);
    k_f_s[32 * npt + i] =
      prefactor_units[32] * fwd_A[32] *
      exp(fwd_beta[32] * tc[i] - activation_units[32] * fwd_Ea[32] * invT[i]);
    k_f_s[33 * npt + i] =
      prefactor_units[33] * fwd_A[33] *
      exp(fwd_beta[33] * tc[i] - activation_units[33] * fwd_Ea[33] * invT[i]);
    k_f_s[34 * npt + i] =
      prefactor_units[34] * fwd_A[34] *
      exp(fwd_beta[34] * tc[i] - activation_units[34] * fwd_Ea[34] * invT[i]);
    k_f_s[35 * npt + i] =
      prefactor_units[35] * fwd_A[35] *
      exp(fwd_beta[35] * tc[i] - activation_units[35] * fwd_Ea[35] * invT[i]);
    k_f_s[36 * npt + i] =
      prefactor_units[36] * fwd_A[36] *
      exp(fwd_beta[36] * tc[i] - activation_units[36] * fwd_Ea[36] * invT[i]);
    k_f_s[37 * npt + i] =
      prefactor_units[37] * fwd_A[37] *
      exp(fwd_beta[37] * tc[i] - activation_units[37] * fwd_Ea[37] * invT[i]);
    k_f_s[38 * npt + i] =
      prefactor_units[38] * fwd_A[38] *
      exp(fwd_beta[38] * tc[i] - activation_units[38] * fwd_Ea[38] * invT[i]);
    k_f_s[39 * npt + i] =
      prefactor_units[39] * fwd_A[39] *
      exp(fwd_beta[39] * tc[i] - activation_units[39] * fwd_Ea[39] * invT[i]);
    k_f_s[40 * npt + i] =
      prefactor_units[40] * fwd_A[40] *
      exp(fwd_beta[40] * tc[i] - activation_units[40] * fwd_Ea[40] * invT[i]);
    k_f_s[41 * npt + i] =
      prefactor_units[41] * fwd_A[41] *
      exp(fwd_beta[41] * tc[i] - activation_units[41] * fwd_Ea[41] * invT[i]);
    k_f_s[42 * npt + i] =
      prefactor_units[42] * fwd_A[42] *
      exp(fwd_beta[42] * tc[i] - activation_units[42] * fwd_Ea[42] * invT[i]);
    k_f_s[43 * npt + i] =
      prefactor_units[43] * fwd_A[43] *
      exp(fwd_beta[43] * tc[i] - activation_units[43] * fwd_Ea[43] * invT[i]);
    k_f_s[44 * npt + i] =
      prefactor_units[44] * fwd_A[44] *
      exp(fwd_beta[44] * tc[i] - activation_units[44] * fwd_Ea[44] * invT[i]);
    k_f_s[45 * npt + i] =
      prefactor_units[45] * fwd_A[45] *
      exp(fwd_beta[45] * tc[i] - activation_units[45] * fwd_Ea[45] * invT[i]);
    k_f_s[46 * npt + i] =
      prefactor_units[46] * fwd_A[46] *
      exp(fwd_beta[46] * tc[i] - activation_units[46] * fwd_Ea[46] * invT[i]);
    k_f_s[47 * npt + i] =
      prefactor_units[47] * fwd_A[47] *
      exp(fwd_beta[47] * tc[i] - activation_units[47] * fwd_Ea[47] * invT[i]);
    k_f_s[48 * npt + i] =
      prefactor_units[48] * fwd_A[48] *
      exp(fwd_beta[48] * tc[i] - activation_units[48] * fwd_Ea[48] * invT[i]);
    k_f_s[49 * npt + i] =
      prefactor_units[49] * fwd_A[49] *
      exp(fwd_beta[49] * tc[i] - activation_units[49] * fwd_Ea[49] * invT[i]);
    k_f_s[50 * npt + i] =
      prefactor_units[50] * fwd_A[50] *
      exp(fwd_beta[50] * tc[i] - activation_units[50] * fwd_Ea[50] * invT[i]);
    k_f_s[51 * npt + i] =
      prefactor_units[51] * fwd_A[51] *
      exp(fwd_beta[51] * tc[i] - activation_units[51] * fwd_Ea[51] * invT[i]);
    k_f_s[52 * npt + i] =
      prefactor_units[52] * fwd_A[52] *
      exp(fwd_beta[52] * tc[i] - activation_units[52] * fwd_Ea[52] * invT[i]);
    k_f_s[53 * npt + i] =
      prefactor_units[53] * fwd_A[53] *
      exp(fwd_beta[53] * tc[i] - activation_units[53] * fwd_Ea[53] * invT[i]);
    k_f_s[54 * npt + i] =
      prefactor_units[54] * fwd_A[54] *
      exp(fwd_beta[54] * tc[i] - activation_units[54] * fwd_Ea[54] * invT[i]);
    k_f_s[55 * npt + i] =
      prefactor_units[55] * fwd_A[55] *
      exp(fwd_beta[55] * tc[i] - activation_units[55] * fwd_Ea[55] * invT[i]);
    k_f_s[56 * npt + i] =
      prefactor_units[56] * fwd_A[56] *
      exp(fwd_beta[56] * tc[i] - activation_units[56] * fwd_Ea[56] * invT[i]);
    k_f_s[57 * npt + i] =
      prefactor_units[57] * fwd_A[57] *
      exp(fwd_beta[57] * tc[i] - activation_units[57] * fwd_Ea[57] * invT[i]);
    k_f_s[58 * npt + i] =
      prefactor_units[58] * fwd_A[58] *
      exp(fwd_beta[58] * tc[i] - activation_units[58] * fwd_Ea[58] * invT[i]);
    k_f_s[59 * npt + i] =
      prefactor_units[59] * fwd_A[59] *
      exp(fwd_beta[59] * tc[i] - activation_units[59] * fwd_Ea[59] * invT[i]);
    k_f_s[60 * npt + i] =
      prefactor_units[60] * fwd_A[60] *
      exp(fwd_beta[60] * tc[i] - activation_units[60] * fwd_Ea[60] * invT[i]);
    k_f_s[61 * npt + i] =
      prefactor_units[61] * fwd_A[61] *
      exp(fwd_beta[61] * tc[i] - activation_units[61] * fwd_Ea[61] * invT[i]);
    k_f_s[62 * npt + i] =
      prefactor_units[62] * fwd_A[62] *
      exp(fwd_beta[62] * tc[i] - activation_units[62] * fwd_Ea[62] * invT[i]);
    k_f_s[63 * npt + i] =
      prefactor_units[63] * fwd_A[63] *
      exp(fwd_beta[63] * tc[i] - activation_units[63] * fwd_Ea[63] * invT[i]);
    k_f_s[64 * npt + i] =
      prefactor_units[64] * fwd_A[64] *
      exp(fwd_beta[64] * tc[i] - activation_units[64] * fwd_Ea[64] * invT[i]);
    k_f_s[65 * npt + i] =
      prefactor_units[65] * fwd_A[65] *
      exp(fwd_beta[65] * tc[i] - activation_units[65] * fwd_Ea[65] * invT[i]);
    k_f_s[66 * npt + i] =
      prefactor_units[66] * fwd_A[66] *
      exp(fwd_beta[66] * tc[i] - activation_units[66] * fwd_Ea[66] * invT[i]);
    k_f_s[67 * npt + i] =
      prefactor_units[67] * fwd_A[67] *
      exp(fwd_beta[67] * tc[i] - activation_units[67] * fwd_Ea[67] * invT[i]);
    k_f_s[68 * npt + i] =
      prefactor_units[68] * fwd_A[68] *
      exp(fwd_beta[68] * tc[i] - activation_units[68] * fwd_Ea[68] * invT[i]);
    k_f_s[69 * npt + i] =
      prefactor_units[69] * fwd_A[69] *
      exp(fwd_beta[69] * tc[i] - activation_units[69] * fwd_Ea[69] * invT[i]);
    k_f_s[70 * npt + i] =
      prefactor_units[70] * fwd_A[70] *
      exp(fwd_beta[70] * tc[i] - activation_units[70] * fwd_Ea[70] * invT[i]);
    k_f_s[71 * npt + i] =
      prefactor_units[71] * fwd_A[71] *
      exp(fwd_beta[71] * tc[i] - activation_units[71] * fwd_Ea[71] * invT[i]);
    k_f_s[72 * npt + i] =
      prefactor_units[72] * fwd_A[72] *
      exp(fwd_beta[72] * tc[i] - activation_units[72] * fwd_Ea[72] * invT[i]);
    k_f_s[73 * npt + i] =
      prefactor_units[73] * fwd_A[73] *
      exp(fwd_beta[73] * tc[i] - activation_units[73] * fwd_Ea[73] * invT[i]);
    k_f_s[74 * npt + i] =
      prefactor_units[74] * fwd_A[74] *
      exp(fwd_beta[74] * tc[i] - activation_units[74] * fwd_Ea[74] * invT[i]);
    k_f_s[75 * npt + i] =
      prefactor_units[75] * fwd_A[75] *
      exp(fwd_beta[75] * tc[i] - activation_units[75] * fwd_Ea[75] * invT[i]);
    k_f_s[76 * npt + i] =
      prefactor_units[76] * fwd_A[76] *
      exp(fwd_beta[76] * tc[i] - activation_units[76] * fwd_Ea[76] * invT[i]);
    k_f_s[77 * npt + i] =
      prefactor_units[77] * fwd_A[77] *
      exp(fwd_beta[77] * tc[i] - activation_units[77] * fwd_Ea[77] * invT[i]);
    k_f_s[78 * npt + i] =
      prefactor_units[78] * fwd_A[78] *
      exp(fwd_beta[78] * tc[i] - activation_units[78] * fwd_Ea[78] * invT[i]);
    k_f_s[79 * npt + i] =
      prefactor_units[79] * fwd_A[79] *
      exp(fwd_beta[79] * tc[i] - activation_units[79] * fwd_Ea[79] * invT[i]);
    k_f_s[80 * npt + i] =
      prefactor_units[80] * fwd_A[80] *
      exp(fwd_beta[80] * tc[i] - activation_units[80] * fwd_Ea[80] * invT[i]);
    k_f_s[81 * npt + i] =
      prefactor_units[81] * fwd_A[81] *
      exp(fwd_beta[81] * tc[i] - activation_units[81] * fwd_Ea[81] * invT[i]);
    k_f_s[82 * npt + i] =
      prefactor_units[82] * fwd_A[82] *
      exp(fwd_beta[82] * tc[i] - activation_units[82] * fwd_Ea[82] * invT[i]);
    k_f_s[83 * npt + i] =
      prefactor_units[83] * fwd_A[83] *
      exp(fwd_beta[83] * tc[i] - activation_units[83] * fwd_Ea[83] * invT[i]);
  }
}

void
vcomp_gibbs(int npt, amrex::Real* g_RT, amrex::Real* tc)
{
...
void
vcomp_Kc(int npt, amrex::Real* Kc_s, amrex::Real* g_RT, amrex::Real* invT)
{
  for (int i = 0; i < npt; i++) {
    ...
    Kc_s[0 * npt + i] =
      refCinv *
      exp((g_RT[1 * npt + i] + g_RT[7 * npt + i]) - (g_RT[9 * npt + i]));
    Kc_s[1 * npt + i] =
      refCinv *
      exp((g_RT[1 * npt + i] + g_RT[9 * npt + i]) - (g_RT[10 * npt + i]));
    Kc_s[2 * npt + i] =
      refCinv *
      exp((g_RT[1 * npt + i] + g_RT[13 * npt + i]) - (g_RT[14 * npt + i]));
    Kc_s[3 * npt + i] =
      refCinv *
      exp((g_RT[1 * npt + i] + g_RT[14 * npt + i]) - (g_RT[15 * npt + i]));
    Kc_s[4 * npt + i] =
      refCinv *
      exp((g_RT[1 * npt + i] + g_RT[16 * npt + i]) - (g_RT[17 * npt + i]));
    Kc_s[5 * npt + i] =
      refCinv *
      exp((g_RT[1 * npt + i] + g_RT[17 * npt + i]) - (g_RT[18 * npt + i]));
    Kc_s[6 * npt + i] =
      refCinv *
      exp((g_RT[0 * npt + i] + g_RT[11 * npt + i]) - (g_RT[14 * npt + i]));
    Kc_s[7 * npt + i] =
      refCinv * exp((2.000000 * g_RT[9 * npt + i]) - (g_RT[18 * npt + i]));
    Kc_s[8 * npt + i] =
      refCinv *
      exp((g_RT[1 * npt + i] + g_RT[2 * npt + i]) - (g_RT[4 * npt + i]));
    Kc_s[9 * npt + i] =
      refCinv *
      exp((g_RT[2 * npt + i] + g_RT[11 * npt + i]) - (g_RT[12 * npt + i]));
    Kc_s[10 * npt + i] =
      refCinv *
      exp((g_RT[1 * npt + i] + g_RT[3 * npt + i]) - (g_RT[6 * npt + i]));
    Kc_s[11 * npt + i] =
      refCinv * exp((2.000000 * g_RT[1 * npt + i]) - (g_RT[0 * npt + i]));
    Kc_s[12 * npt + i] =
      refCinv *
      exp((g_RT[1 * npt + i] + g_RT[4 * npt + i]) - (g_RT[5 * npt + i]));
    Kc_s[13 * npt + i] =
      refC *
      exp((g_RT[13 * npt + i]) - (g_RT[1 * npt + i] + g_RT[11 * npt + i]));
    Kc_s[14 * npt + i] = exp(
      (g_RT[0 * npt + i] + g_RT[2 * npt + i]) -
      (g_RT[1 * npt + i] + g_RT[4 * npt + i]));
    Kc_s[15 * npt + i] = exp(
      (g_RT[2 * npt + i] + g_RT[6 * npt + i]) -
      (g_RT[3 * npt + i] + g_RT[4 * npt + i]));
    Kc_s[16 * npt + i] = exp(
      (g_RT[2 * npt + i] + g_RT[7 * npt + i]) -
      (g_RT[1 * npt + i] + g_RT[13 * npt + i]));
    Kc_s[17 * npt + i] = exp(
      (g_RT[2 * npt + i] + g_RT[8 * npt + i]) -
      (g_RT[1 * npt + i] + g_RT[13 * npt + i]));
    Kc_s[18 * npt + i] = exp(
      (g_RT[2 * npt + i] + g_RT[9 * npt + i]) -
      (g_RT[1 * npt + i] + g_RT[14 * npt + i]));
    Kc_s[19 * npt + i] = exp(
      (g_RT[2 * npt + i] + g_RT[10 * npt + i]) -
      (g_RT[4 * npt + i] + g_RT[9 * npt + i]));
    Kc_s[20 * npt + i] = exp(
      (g_RT[2 * npt + i] + g_RT[13 * npt + i]) -
      (g_RT[4 * npt + i] + g_RT[11 * npt + i]));
    Kc_s[21 * npt + i] = exp(
      (g_RT[2 * npt + i] + g_RT[13 * npt + i]) -
      (g_RT[1 * npt + i] + g_RT[12 * npt + i]));
    Kc_s[22 * npt + i] = exp(
      (g_RT[2 * npt + i] + g_RT[14 * npt + i]) -
      (g_RT[4 * npt + i] + g_RT[13 * npt + i]));
    Kc_s[23 * npt + i] = exp(
      (g_RT[2 * npt + i] + g_RT[16 * npt + i]) -
      (g_RT[9 * npt + i] + g_RT[13 * npt + i]));
    Kc_s[24 * npt + i] = exp(
      (g_RT[2 * npt + i] + g_RT[17 * npt + i]) -
      (g_RT[9 * npt + i] + g_RT[14 * npt + i]));
    Kc_s[25 * npt + i] = exp(
      (g_RT[2 * npt + i] + g_RT[18 * npt + i]) -
      (g_RT[4 * npt + i] + g_RT[17 * npt + i]));
    Kc_s[26 * npt + i] = exp(
      (g_RT[3 * npt + i] + g_RT[11 * npt + i]) -
      (g_RT[2 * npt + i] + g_RT[12 * npt + i]));
    Kc_s[27 * npt + i] = exp(
      (g_RT[3 * npt + i] + g_RT[14 * npt + i]) -
      (g_RT[6 * npt + i] + g_RT[13 * npt + i]));
    Kc_s[28 * npt + i] =
      refCinv * exp(
                  (g_RT[1 * npt + i] + 2.000000 * g_RT[3 * npt + i]) -
                  (g_RT[3 * npt + i] + g_RT[6 * npt + i]));
    Kc_s[29 * npt + i] =
      refCinv * exp(
                  (g_RT[1 * npt + i] + g_RT[3 * npt + i] + g_RT[5 * npt + i]) -
                  (g_RT[5 * npt + i] + g_RT[6 * npt + i]));
    Kc_s[30 * npt + i] =
      refCinv * exp(
                  (g_RT[1 * npt + i] + g_RT[3 * npt + i] + g_RT[19 * npt + i]) -
                  (g_RT[6 * npt + i] + g_RT[19 * npt + i]));
    Kc_s[31 * npt + i] =
      refCinv * exp(
                  (g_RT[1 * npt + i] + g_RT[3 * npt + i] + g_RT[20 * npt + i]) -
                  (g_RT[6 * npt + i] + g_RT[20 * npt + i]));
    Kc_s[32 * npt + i] = exp(
      (g_RT[1 * npt + i] + g_RT[3 * npt + i]) -
      (g_RT[2 * npt + i] + g_RT[4 * npt + i]));
    Kc_s[33 * npt + i] =
      refCinv * exp(
                  (g_RT[0 * npt + i] + 2.000000 * g_RT[1 * npt + i]) -
                  (2.000000 * g_RT[0 * npt + i]));
    Kc_s[34 * npt + i] =
      refCinv * exp(
                  (2.000000 * g_RT[1 * npt + i] + g_RT[5 * npt + i]) -
                  (g_RT[0 * npt + i] + g_RT[5 * npt + i]));
    Kc_s[35 * npt + i] =
      refCinv * exp(
                  (2.000000 * g_RT[1 * npt + i] + g_RT[12 * npt + i]) -
                  (g_RT[0 * npt + i] + g_RT[12 * npt + i]));
    Kc_s[36 * npt + i] = exp(
      (g_RT[1 * npt + i] + g_RT[6 * npt + i]) -
      (g_RT[0 * npt + i] + g_RT[3 * npt + i]));
    Kc_s[37 * npt + i] = exp(
      (g_RT[1 * npt + i] + g_RT[6 * npt + i]) - (2.000000 * g_RT[4 * npt + i]));
    Kc_s[38 * npt + i] = exp(
      (g_RT[1 * npt + i] + g_RT[10 * npt + i]) -
      (g_RT[0 * npt + i] + g_RT[9 * npt + i]));
    Kc_s[39 * npt + i] = exp(
      (g_RT[1 * npt + i] + g_RT[13 * npt + i]) -
      (g_RT[0 * npt + i] + g_RT[11 * npt + i]));
    Kc_s[40 * npt + i] = exp(
      (g_RT[1 * npt + i] + g_RT[14 * npt + i]) -
      (g_RT[0 * npt + i] + g_RT[13 * npt + i]));
    Kc_s[41 * npt + i] = exp(
      (g_RT[1 * npt + i] + g_RT[15 * npt + i]) -
      (g_RT[4 * npt + i] + g_RT[9 * npt + i]));
    Kc_s[42 * npt + i] = exp(
      (g_RT[1 * npt + i] + g_RT[18 * npt + i]) -
      (g_RT[0 * npt + i] + g_RT[17 * npt + i]));
    Kc_s[43 * npt + i] = exp(
      (g_RT[0 * npt + i] + g_RT[4 * npt + i]) -
      (g_RT[1 * npt + i] + g_RT[5 * npt + i]));
    Kc_s[44 * npt + i] = exp(
      (2.000000 * g_RT[4 * npt + i]) - (g_RT[2 * npt + i] + g_RT[5 * npt + i]));
    Kc_s[45 * npt + i] = exp(
      (g_RT[4 * npt + i] + g_RT[6 * npt + i]) -
      (g_RT[3 * npt + i] + g_RT[5 * npt + i]));
    Kc_s[46 * npt + i] = exp(
      (g_RT[4 * npt + i] + g_RT[7 * npt + i]) -
      (g_RT[1 * npt + i] + g_RT[14 * npt + i]));
    Kc_s[47 * npt + i] = exp(
      (g_RT[4 * npt + i] + g_RT[8 * npt + i]) -
      (g_RT[1 * npt + i] + g_RT[14 * npt + i]));
    Kc_s[48 * npt + i] = exp(
      (g_RT[4 * npt + i] + g_RT[9 * npt + i]) -
    ...
    Kc_s[49 * npt + i] = exp(
      (g_RT[4 * npt + i] + g_RT[9 * npt + i]) -
      (g_RT[5 * npt + i] + g_RT[8 * npt + i]));
    Kc_s[50 * npt + i] = exp(
      (g_RT[4 * npt + i] + g_RT[10 * npt + i]) -
    ...
    Kc_s[52 * npt + i] = exp(
      (g_RT[4 * npt + i] + g_RT[13 * npt + i]) -
      (g_RT[5 * npt + i] + g_RT[11 * npt + i]));
    Kc_s[53 * npt + i] = exp(
      (g_RT[4 * npt + i] + g_RT[14 * npt + i]) -
      (g_RT[5 * npt + i] + g_RT[13 * npt + i]));
    Kc_s[54 * npt + i] = exp(
      (g_RT[4 * npt + i] + g_RT[18 * npt + i]) -
      (g_RT[5 * npt + i] + g_RT[17 * npt + i]));
    Kc_s[55 * npt + i] = exp(
      (g_RT[6 * npt + i] + g_RT[7 * npt + i]) -
      (g_RT[4 * npt + i] + g_RT[14 * npt + i]));
    Kc_s[56 * npt + i] = exp(
      (g_RT[6 * npt + i] + g_RT[9 * npt + i]) -
      (g_RT[3 * npt + i] + g_RT[10 * npt + i]));
    Kc_s[57 * npt + i] = exp(
      (g_RT[6 * npt + i] + g_RT[9 * npt + i]) -
      (g_RT[4 * npt + i] + g_RT[15 * npt + i]));
    Kc_s[58 * npt + i] = exp(
      (g_RT[6 * npt + i] + g_RT[11 * npt + i]) -
      (g_RT[4 * npt + i] + g_RT[12 * npt + i]));
    Kc_s[59 * npt + i] = exp(
    ...
    Kc_s[61 * npt + i] = exp(
      (g_RT[7 * npt + i] + g_RT[9 * npt + i]) -
      (g_RT[1 * npt + i] + g_RT[16 * npt + i]));
    Kc_s[62 * npt + i] = exp(
      (g_RT[7 * npt + i] + g_RT[10 * npt + i]) -
      (2.000000 * g_RT[9 * npt + i]));
    Kc_s[63 * npt + i] = exp(
      (g_RT[8 * npt + i] + g_RT[19 * npt + i]) -
      (g_RT[7 * npt + i] + g_RT[19 * npt + i]));
    Kc_s[64 * npt + i] = exp(
      (g_RT[8 * npt + i] + g_RT[20 * npt + i]) -
      (g_RT[7 * npt + i] + g_RT[20 * npt + i]));
    Kc_s[65 * npt + i] =
      refC * exp(
               (g_RT[3 * npt + i] + g_RT[8 * npt + i]) -
               (g_RT[1 * npt + i] + g_RT[4 * npt + i] + g_RT[11 * npt + i]));
    Kc_s[66 * npt + i] = exp(
      (g_RT[3 * npt + i] + g_RT[8 * npt + i]) -
      (g_RT[5 * npt + i] + g_RT[11 * npt + i]));
    Kc_s[67 * npt + i] = exp(
      (g_RT[0 * npt + i] + g_RT[8 * npt + i]) -
      (g_RT[1 * npt + i] + g_RT[9 * npt + i]));
    Kc_s[68 * npt + i] = exp(
      (g_RT[5 * npt + i] + g_RT[8 * npt + i]) -
      (g_RT[5 * npt + i] + g_RT[7 * npt + i]));
    Kc_s[69 * npt + i] = exp(
      (g_RT[8 * npt + i] + g_RT[9 * npt + i]) -
      (g_RT[1 * npt + i] + g_RT[16 * npt + i]));
    Kc_s[70 * npt + i] = exp(
      (g_RT[8 * npt + i] + g_RT[10 * npt + i]) -
      (2.000000 * g_RT[9 * npt + i]));
    Kc_s[71 * npt + i] = exp(
      (g_RT[8 * npt + i] + g_RT[11 * npt + i]) -
      (g_RT[7 * npt + i] + g_RT[11 * npt + i]));
    Kc_s[72 * npt + i] = exp(
      (g_RT[8 * npt + i] + g_RT[12 * npt + i]) -
      (g_RT[7 * npt + i] + g_RT[12 * npt + i]));
    Kc_s[73 * npt + i] = exp(
      (g_RT[8 * npt + i] + g_RT[12 * npt + i]) -
      (g_RT[11 * npt + i] + g_RT[14 * npt + i]));
    Kc_s[74 * npt + i] = exp(
      (g_RT[3 * npt + i] + g_RT[9 * npt + i]) -
      (g_RT[2 * npt + i] + g_RT[15 * npt + i]));
    Kc_s[75 * npt + i] = exp(
      (g_RT[3 * npt + i] + g_RT[9 * npt + i]) -
      (g_RT[4 * npt + i] + g_RT[14 * npt + i]));
    Kc_s[76 * npt + i] = exp(
      (2.000000 * g_RT[9 * npt + i]) -
      (g_RT[1 * npt + i] + g_RT[17 * npt + i]));
    Kc_s[77 * npt + i] = exp(
      (g_RT[9 * npt + i] + g_RT[13 * npt + i]) -
      (g_RT[10 * npt + i] + g_RT[11 * npt + i]));
    Kc_s[78 * npt + i] = exp(
      (g_RT[9 * npt + i] + g_RT[14 * npt + i]) -
      (g_RT[10 * npt + i] + g_RT[13 * npt + i]));
    Kc_s[79 * npt + i] = exp(
      (g_RT[9 * npt + i] + g_RT[18 * npt + i]) -
      (g_RT[10 * npt + i] + g_RT[17 * npt + i]));
    Kc_s[80 * npt + i] =
      refC * exp(
               (g_RT[5 * npt + i] + g_RT[13 * npt + i]) -
               (g_RT[1 * npt + i] + g_RT[5 * npt + i] + g_RT[11 * npt + i]));
    Kc_s[81 * npt + i] = exp(
      (g_RT[3 * npt + i] + g_RT[13 * npt + i]) -
      (g_RT[6 * npt + i] + g_RT[11 * npt + i]));
    Kc_s[82 * npt + i] = exp(
      (g_RT[3 * npt + i] + g_RT[15 * npt + i]) -
      (g_RT[6 * npt + i] + g_RT[14 * npt + i]));
    Kc_s[83 * npt + i] = exp(
      (g_RT[3 * npt + i] + g_RT[17 * npt + i]) -
      (g_RT[6 * npt + i] + g_RT[16 * npt + i]));
  }
}
  ...
  amrex::Real* T)
{
  for (int i = 0; i < npt; i++) {
    ...
    alpha =
      mixture[i] + (TB[0][0] - 1) * sc[0 * npt + i] +
      (TB[0][1] - 1) * sc[5 * npt + i] + (TB[0][2] - 1) * sc[10 * npt + i] +
      (TB[0][3] - 1) * sc[11 * npt + i] + (TB[0][4] - 1) * sc[12 * npt + i] +
      (TB[0][5] - 1) * sc[18 * npt + i] + (TB[0][6] - 1) * sc[20 * npt + i];
    k_f = k_f_s[0 * npt + i];
    ...
    alpha =
      mixture[i] + (TB[1][0] - 1) * sc[0 * npt + i] +
      (TB[1][1] - 1) * sc[5 * npt + i] + (TB[1][2] - 1) * sc[10 * npt + i] +
      (TB[1][3] - 1) * sc[11 * npt + i] + (TB[1][4] - 1) * sc[12 * npt + i] +
      (TB[1][5] - 1) * sc[18 * npt + i] + (TB[1][6] - 1) * sc[20 * npt + i];
    k_f = k_f_s[1 * npt + i];
    ...
    alpha =
      mixture[i] + (TB[2][0] - 1) * sc[0 * npt + i] +
      (TB[2][1] - 1) * sc[5 * npt + i] + (TB[2][2] - 1) * sc[10 * npt + i] +
      (TB[2][3] - 1) * sc[11 * npt + i] + (TB[2][4] - 1) * sc[12 * npt + i] +
      (TB[2][5] - 1) * sc[18 * npt + i] + (TB[2][6] - 1) * sc[20 * npt + i];
    k_f = k_f_s[2 * npt + i];
    redP = alpha / k_f * phase_units[2] * low_A[2] *
           exp(low_beta[2] * tc[i] - activation_units[2] * low_Ea[2] * invT[i]);
    F = redP / (1 + redP);
    logPred = log10(redP);
    logFcent = log10(
      (fabs(troe_Tsss[2]) > 1.e-100
         ? (1. - troe_a[2]) * exp(-T[i] / troe_Tsss[2])
         : 0.) +
    ...
    alpha =
      mixture[i] + (TB[3][0] - 1) * sc[0 * npt + i] +
      (TB[3][1] - 1) * sc[5 * npt + i] + (TB[3][2] - 1) * sc[10 * npt + i] +
      (TB[3][3] - 1) * sc[11 * npt + i] + (TB[3][4] - 1) * sc[12 * npt + i] +
      (TB[3][5] - 1) * sc[18 * npt + i];
    k_f = k_f_s[3 * npt + i];
    redP = alpha / k_f * phase_units[3] * low_A[3] *
           exp(low_beta[3] * tc[i] - activation_units[3] * low_Ea[3] * invT[i]);
    F = redP / (1 + redP);
    logPred = log10(redP);
    logFcent = log10(
      (fabs(troe_Tsss[3]) > 1.e-100
         ? (1. - troe_a[3]) * exp(-T[i] / troe_Tsss[3])
         : 0.) +
    ...
    alpha =
      mixture[i] + (TB[4][0] - 1) * sc[0 * npt + i] +
      (TB[4][1] - 1) * sc[5 * npt + i] + (TB[4][2] - 1) * sc[10 * npt + i] +
      (TB[4][3] - 1) * sc[11 * npt + i] + (TB[4][4] - 1) * sc[12 * npt + i] +
      (TB[4][5] - 1) * sc[18 * npt + i] + (TB[4][6] - 1) * sc[20 * npt + i];
    k_f = k_f_s[4 * npt + i];
    redP = alpha / k_f * phase_units[4] * low_A[4] *
           exp(low_beta[4] * tc[i] - activation_units[4] * low_Ea[4] * invT[i]);
    F = redP / (1 + redP);
    logPred = log10(redP);
    logFcent = log10(
      (fabs(troe_Tsss[4]) > 1.e-100
         ? (1. - troe_a[4]) * exp(-T[i] / troe_Tsss[4])
         : 0.) +
    ...
    alpha =
      mixture[i] + (TB[5][0] - 1) * sc[0 * npt + i] +
      (TB[5][1] - 1) * sc[5 * npt + i] + (TB[5][2] - 1) * sc[10 * npt + i] +
      (TB[5][3] - 1) * sc[11 * npt + i] + (TB[5][4] - 1) * sc[12 * npt + i] +
      (TB[5][5] - 1) * sc[18 * npt + i] + (TB[5][6] - 1) * sc[20 * npt + i];
    k_f = k_f_s[5 * npt + i];
    redP = alpha / k_f * phase_units[5] * low_A[5] *
           exp(low_beta[5] * tc[i] - activation_units[5] * low_Ea[5] * invT[i]);
    F = redP / (1 + redP);
    logPred = log10(redP);
    logFcent = log10(
      (fabs(troe_Tsss[5]) > 1.e-100
         ? (1. - troe_a[5]) * exp(-T[i] / troe_Tsss[5])
         : 0.) +
    ...
    alpha =
      mixture[i] + (TB[6][0] - 1) * sc[0 * npt + i] +
      (TB[6][1] - 1) * sc[5 * npt + i] + (TB[6][2] - 1) * sc[10 * npt + i] +
      (TB[6][3] - 1) * sc[11 * npt + i] + (TB[6][4] - 1) * sc[12 * npt + i] +
      (TB[6][5] - 1) * sc[18 * npt + i] + (TB[6][6] - 1) * sc[20 * npt + i];
    k_f = k_f_s[6 * npt + i];
    redP = alpha / k_f * phase_units[6] * low_A[6] *
           exp(low_beta[6] * tc[i] - activation_units[6] * low_Ea[6] * invT[i]);
    F = redP / (1 + redP);
    logPred = log10(redP);
    logFcent = log10(
      (fabs(troe_Tsss[6]) > 1.e-100
         ? (1. - troe_a[6]) * exp(-T[i] / troe_Tsss[6])
         : 0.) +
    ...
    alpha =
      mixture[i] + (TB[7][0] - 1) * sc[0 * npt + i] +
      (TB[7][1] - 1) * sc[5 * npt + i] + (TB[7][2] - 1) * sc[10 * npt + i] +
      (TB[7][3] - 1) * sc[11 * npt + i] + (TB[7][4] - 1) * sc[12 * npt + i] +
      (TB[7][5] - 1) * sc[18 * npt + i] + (TB[7][6] - 1) * sc[20 * npt + i];
    k_f = k_f_s[7 * npt + i];
    redP = alpha / k_f * phase_units[7] * low_A[7] *
           exp(low_beta[7] * tc[i] - activation_units[7] * low_Ea[7] * invT[i]);
    F = redP / (1 + redP);
    logPred = log10(redP);
    logFcent = log10(
      (fabs(troe_Tsss[7]) > 1.e-100
         ? (1. - troe_a[7]) * exp(-T[i] / troe_Tsss[7])
         : 0.) +
    ...
    alpha =
      mixture[i] + (TB[8][0] - 1) * sc[0 * npt + i] +
      (TB[8][1] - 1) * sc[5 * npt + i] + (TB[8][2] - 1) * sc[10 * npt + i] +
      (TB[8][3] - 1) * sc[11 * npt + i] + (TB[8][4] - 1) * sc[12 * npt + i] +
      (TB[8][5] - 1) * sc[18 * npt + i] + (TB[8][6] - 1) * sc[20 * npt + i];
    ...
    alpha =
      mixture[i] + (TB[9][0] - 1) * sc[0 * npt + i] +
      (TB[9][1] - 1) * sc[3 * npt + i] + (TB[9][2] - 1) * sc[5 * npt + i] +
      (TB[9][3] - 1) * sc[10 * npt + i] + (TB[9][4] - 1) * sc[11 * npt + i] +
      (TB[9][5] - 1) * sc[12 * npt + i] + (TB[9][6] - 1) * sc[18 * npt + i] +
      (TB[9][7] - 1) * sc[20 * npt + i];
    ...
    alpha =
      mixture[i] + (TB[10][0] - 1) * sc[3 * npt + i] +
      (TB[10][1] - 1) * sc[5 * npt + i] + (TB[10][2] - 1) * sc[11 * npt + i] +
      (TB[10][3] - 1) * sc[12 * npt + i] + (TB[10][4] - 1) * sc[18 * npt + i] +
      (TB[10][5] - 1) * sc[19 * npt + i] + (TB[10][6] - 1) * sc[20 * npt + i];
    ...
    alpha =
      mixture[i] + (TB[11][0] - 1) * sc[0 * npt + i] +
      (TB[11][1] - 1) * sc[5 * npt + i] + (TB[11][2] - 1) * sc[10 * npt + i] +
      (TB[11][3] - 1) * sc[12 * npt + i] + (TB[11][4] - 1) * sc[18 * npt + i] +
      (TB[11][5] - 1) * sc[20 * npt + i];
    ...
    alpha =
      mixture[i] + (TB[12][0] - 1) * sc[0 * npt + i] +
      (TB[12][1] - 1) * sc[5 * npt + i] + (TB[12][2] - 1) * sc[10 * npt + i] +
      (TB[12][3] - 1) * sc[18 * npt + i] + (TB[12][4] - 1) * sc[20 * npt + i];
    ...
    phi_f = sc[13 * npt + i];
    alpha =
      mixture[i] + (TB[13][0] - 1) * sc[0 * npt + i] +
      (TB[13][1] - 1) * sc[5 * npt + i] + (TB[13][2] - 1) * sc[10 * npt + i] +
      (TB[13][3] - 1) * sc[11 * npt + i] + (TB[13][4] - 1) * sc[12 * npt + i] +
      (TB[13][5] - 1) * sc[18 * npt + i];
...
void
comp_k_f(amrex::Real* tc, amrex::Real invT, amrex::Real* k_f)
{
  for (int i = 0; i < 84; ++i) {
...
void
comp_Kc(amrex::Real* tc, amrex::Real invT, amrex::Real* Kc)
{
  /*compute the Gibbs free energy */
  amrex::Real g_RT[21];
  gibbs(g_RT, tc);
  ...
  amrex::Real invT)
{
  ...
  /* troe */
  {
    ...
    alpha[0] = mixture + (TB[0][0] - 1) * sc[0] + (TB[0][1] - 1) * sc[5] +
               (TB[0][2] - 1) * sc[10] + (TB[0][3] - 1) * sc[11] +
               (TB[0][4] - 1) * sc[12] + (TB[0][5] - 1) * sc[18] +
               (TB[0][6] - 1) * sc[20];
    alpha[1] = mixture + (TB[1][0] - 1) * sc[0] + (TB[1][1] - 1) * sc[5] +
               (TB[1][2] - 1) * sc[10] + (TB[1][3] - 1) * sc[11] +
               (TB[1][4] - 1) * sc[12] + (TB[1][5] - 1) * sc[18] +
               (TB[1][6] - 1) * sc[20];
    alpha[2] = mixture + (TB[2][0] - 1) * sc[0] + (TB[2][1] - 1) * sc[5] +
               (TB[2][2] - 1) * sc[10] + (TB[2][3] - 1) * sc[11] +
               (TB[2][4] - 1) * sc[12] + (TB[2][5] - 1) * sc[18] +
               (TB[2][6] - 1) * sc[20];
    alpha[3] = mixture + (TB[3][0] - 1) * sc[0] + (TB[3][1] - 1) * sc[5] +
               (TB[3][2] - 1) * sc[10] + (TB[3][3] - 1) * sc[11] +
               (TB[3][4] - 1) * sc[12] + (TB[3][5] - 1) * sc[18];
    alpha[4] = mixture + (TB[4][0] - 1) * sc[0] + (TB[4][1] - 1) * sc[5] +
               (TB[4][2] - 1) * sc[10] + (TB[4][3] - 1) * sc[11] +
               (TB[4][4] - 1) * sc[12] + (TB[4][5] - 1) * sc[18] +
               (TB[4][6] - 1) * sc[20];
    alpha[5] = mixture + (TB[5][0] - 1) * sc[0] + (TB[5][1] - 1) * sc[5] +
               (TB[5][2] - 1) * sc[10] + (TB[5][3] - 1) * sc[11] +
               (TB[5][4] - 1) * sc[12] + (TB[5][5] - 1) * sc[18] +
               (TB[5][6] - 1) * sc[20];
    alpha[6] = mixture + (TB[6][0] - 1) * sc[0] + (TB[6][1] - 1) * sc[5] +
               (TB[6][2] - 1) * sc[10] + (TB[6][3] - 1) * sc[11] +
               (TB[6][4] - 1) * sc[12] + (TB[6][5] - 1) * sc[18] +
               (TB[6][6] - 1) * sc[20];
    alpha[7] = mixture + (TB[7][0] - 1) * sc[0] + (TB[7][1] - 1) * sc[5] +
               (TB[7][2] - 1) * sc[10] + (TB[7][3] - 1) * sc[11] +
               (TB[7][4] - 1) * sc[12] + (TB[7][5] - 1) * sc[18] +
               (TB[7][6] - 1) * sc[20];
    for (int i = 0; i < 8; i++) {
  ...
  {
    amrex::Real alpha;
    alpha = mixture + (TB[8][0] - 1) * sc[0] + (TB[8][1] - 1) * sc[5] +
            (TB[8][2] - 1) * sc[10] + (TB[8][3] - 1) * sc[11] +
            (TB[8][4] - 1) * sc[12] + (TB[8][5] - 1) * sc[18] +
            (TB[8][6] - 1) * sc[20];
    Corr[8] = alpha;
    alpha = mixture + (TB[9][0] - 1) * sc[0] + (TB[9][1] - 1) * sc[3] +
            (TB[9][2] - 1) * sc[5] + (TB[9][3] - 1) * sc[10] +
            (TB[9][4] - 1) * sc[11] + (TB[9][5] - 1) * sc[12] +
            (TB[9][6] - 1) * sc[18] + (TB[9][7] - 1) * sc[20];
    Corr[9] = alpha;
    alpha = mixture + (TB[10][0] - 1) * sc[3] + (TB[10][1] - 1) * sc[5] +
            (TB[10][2] - 1) * sc[11] + (TB[10][3] - 1) * sc[12] +
            (TB[10][4] - 1) * sc[18] + (TB[10][5] - 1) * sc[19] +
            (TB[10][6] - 1) * sc[20];
    Corr[10] = alpha;
    alpha = mixture + (TB[11][0] - 1) * sc[0] + (TB[11][1] - 1) * sc[5] +
            (TB[11][2] - 1) * sc[10] + (TB[11][3] - 1) * sc[12] +
            (TB[11][4] - 1) * sc[18] + (TB[11][5] - 1) * sc[20];
    Corr[11] = alpha;
    alpha = mixture + (TB[12][0] - 1) * sc[0] + (TB[12][1] - 1) * sc[5] +
            (TB[12][2] - 1) * sc[10] + (TB[12][3] - 1) * sc[18] +
            (TB[12][4] - 1) * sc[20];
    Corr[12] = alpha;
    alpha = mixture + (TB[13][0] - 1) * sc[0] + (TB[13][1] - 1) * sc[5] +
            (TB[13][2] - 1) * sc[10] + (TB[13][3] - 1) * sc[11] +
            (TB[13][4] - 1) * sc[12] + (TB[13][5] - 1) * sc[18];
    Corr[13] = alpha;
  }
...
void
progressRate(amrex::Real* qdot, amrex::Real* sc, amrex::Real T)
{
  amrex::Real tc[] = {
    log(T), T, T * T, T * T * T, T * T * T * T}; /*temperature cache */
  amrex::Real invT = 1.0 / tc[1];
...
void
CKQC(amrex::Real* T, amrex::Real* C, amrex::Real* qdot)
{
  int id; /*loop counter */
...
void
CKQYP(amrex::Real* P, amrex::Real* T, amrex::Real* y, amrex::Real* qdot)
{
  int id;            /*loop counter */
  amrex::Real c[21]; /*temporary storage */
  amrex::Real YOW = 0;
...
/*Given P, T, and mole fractions */
void
CKQXP(amrex::Real* P, amrex::Real* T, amrex::Real* x, amrex::Real* qdot)
{
  int id;            /*loop counter */
  amrex::Real c[21]; /*temporary storage */
  amrex::Real PORT =
...
/*Given rho, T, and mass fractions */
void
CKQYR(amrex::Real* rho, amrex::Real* T, amrex::Real* y, amrex::Real* qdot)
{
  int id;            /*loop counter */
  amrex::Real c[21]; /*temporary storage */
  amrex::Real imw[21];
...
void
CKQXR(amrex::Real* rho, amrex::Real* T, amrex::Real* x, amrex::Real* qdot)
{
  int id;             /*loop counter */
  amrex::Real c[21];  /*temporary storage */
...
aJacobian(amrex::Real* J, amrex::Real* sc, amrex::Real T, int consP)
{
  ...
  /* pressure-fall-off */
  k_0 = low_A[2] *
        exp(low_beta[2] * tc[0] - activation_units[2] * low_Ea[2] * invT);
  ...
  logPr = log10(Pr);
  Fcent1 =
    (fabs(troe_Tsss[2]) > 1.e-100 ? (1. - troe_a[2]) * exp(-T / troe_Tsss[2])
                                  : 0.);
  ...
  /* pressure-fall-off */
  k_0 = low_A[3] *
        exp(low_beta[3] * tc[0] - activation_units[3] * low_Ea[3] * invT);
  ...
  logPr = log10(Pr);
  Fcent1 =
    (fabs(troe_Tsss[3]) > 1.e-100 ? (1. - troe_a[3]) * exp(-T / troe_Tsss[3])
                                  : 0.);
  ...
  /* pressure-fall-off */
  k_0 = low_A[4] *
        exp(low_beta[4] * tc[0] - activation_units[4] * low_Ea[4] * invT);
  ...
  logPr = log10(Pr);
  Fcent1 =
    (fabs(troe_Tsss[4]) > 1.e-100 ? (1. - troe_a[4]) * exp(-T / troe_Tsss[4])
                                  : 0.);
  ...
  /* pressure-fall-off */
  k_0 = low_A[5] *
        exp(low_beta[5] * tc[0] - activation_units[5] * low_Ea[5] * invT);
  ...
  logPr = log10(Pr);
  Fcent1 =
    (fabs(troe_Tsss[5]) > 1.e-100 ? (1. - troe_a[5]) * exp(-T / troe_Tsss[5])
                                  : 0.);
  ...
  /* also 3-body */
  /* 3-body correction factor */
  alpha = mixture + (TB[6][0] - 1) * sc[0] + (TB[6][1] - 1) * sc[5] +
          (TB[6][2] - 1) * sc[10] + (TB[6][3] - 1) * sc[11] +
          (TB[6][4] - 1) * sc[12] + (TB[6][5] - 1) * sc[18] +
          (TB[6][6] - 1) * sc[20];
  /* forward */
  ...
  /* pressure-fall-off */
  k_0 = low_A[6] *
        exp(low_beta[6] * tc[0] - activation_units[6] * low_Ea[6] * invT);
  ...
  logPr = log10(Pr);
  Fcent1 =
    (fabs(troe_Tsss[6]) > 1.e-100 ? (1. - troe_a[6]) * exp(-T / troe_Tsss[6])
                                  : 0.);
  ...
  /* also 3-body */
  /* 3-body correction factor */
  alpha = mixture + (TB[7][0] - 1) * sc[0] + (TB[7][1] - 1) * sc[5] +
          (TB[7][2] - 1) * sc[10] + (TB[7][3] - 1) * sc[11] +
          (TB[7][4] - 1) * sc[12] + (TB[7][5] - 1) * sc[18] +
          (TB[7][6] - 1) * sc[20];
  /* forward */
  ...
  /* pressure-fall-off */
  k_0 = low_A[7] *
        exp(low_beta[7] * tc[0] - activation_units[7] * low_Ea[7] * invT);
  ...
  logPr = log10(Pr);
  Fcent1 =
    (fabs(troe_Tsss[7]) > 1.e-100 ? (1. - troe_a[7]) * exp(-T / troe_Tsss[7])
                                  : 0.);
  ...
  k_r = k_f / Kc;
  dlnKcdT =
    invT * (-(h_RT[1] + h_RT[3] + h_RT[19]) + (h_RT[6] + h_RT[19]) + 1.000000);
  dkrdT = (dlnkfdT - dlnKcdT) * k_r;
  /* rate of progress */
  q = k_f * phi_f - k_r * phi_r;
  dqdT = (dlnkfdT * k_f * phi_f - dkrdT * phi_r);
  ...
  k_r = k_f / Kc;
  dlnKcdT =
    invT * (-(h_RT[1] + h_RT[3] + h_RT[20]) + (h_RT[6] + h_RT[20]) + 1.000000);
  dkrdT = (dlnkfdT - dlnKcdT) * k_r;
  /* rate of progress */
  q = k_f * phi_f - k_r * phi_r;
  dqdT = (dlnkfdT * k_f * phi_f - dkrdT * phi_r);
  ...
  k_r = k_f / Kc;
  dlnKcdT =
    invT * (-(2.000000 * h_RT[1] + h_RT[12]) + (h_RT[0] + h_RT[12]) + 1.000000);
  dkrdT = (dlnkfdT - dlnKcdT) * k_r;
  /* rate of progress */
  q = k_f * phi_f - k_r * phi_r;
  dqdT = (dlnkfdT * k_f * phi_f - dkrdT * phi_r);
  ...
  k_r = k_f / Kc;
  dlnKcdT =
    invT * (-(h_RT[3] + h_RT[8]) + (h_RT[1] + h_RT[4] + h_RT[11]) - 1.000000);
  dkrdT = (dlnkfdT - dlnKcdT) * k_r;
  /* rate of progress */
  q = k_f * phi_f - k_r * phi_r;
  dqdT = (dlnkfdT * k_f * phi_f - dkrdT * phi_r);
  ...
  k_r = k_f / Kc;
  dlnKcdT =
    invT * (-(h_RT[5] + h_RT[13]) + (h_RT[1] + h_RT[5] + h_RT[11]) - 1.000000);
  dkrdT = (dlnkfdT - dlnKcdT) * k_r;
  /* rate of progress */
  q = k_f * phi_f - k_r * phi_r;
  dqdT = (dlnkfdT * k_f * phi_f - dkrdT * phi_r);
...
CKINIT()
{
  ...
  TBid[12][0] = 0;
  TB[12][0] = 0.72999999999999998; // H2
  TBid[12][1] = 5;
  TB[12][1] = 3.6499999999999999; // H2O
  TBid[12][2] = 10;
  TB[12][2] = 2; // CH4
  TBid[12][3] = 18;
  TB[12][3] = 3; // C2H6
...
SPARSITY_INFO(int* nJdata, int* consP, int NCELLS)
{
  ...
  amrex::ParallelFor(
    amrex::Box(iv, iv), [=] AMREX_GPU_DEVICE(int i, int j, int k) noexcept {
      for (int k = 0; k < 21; k++) {
        c_d[k] = 1.0 / 21.000000;
      }
