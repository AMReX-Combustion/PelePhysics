...
class HelloApp(Application):
    ...
    class Inventory(Application.Inventory):
        ...
        inventory = (
            ...
            pyre.properties.dimensional("vector", default=[0.0*si.meter, 0.0*si.meter]),

            # validators
            pyre.properties.float("less", validator=pyre.properties.less(0.0)),
            pyre.properties.float("greater", validator=pyre.properties.greater(0.0)),
            pyre.properties.float("range", validator=pyre.properties.range(0.0, 1.0)),
            pyre.properties.str("choice", validator=pyre.properties.choice(["yes", "no"]))
            )
