...
app = FMC()
app.inventory.mechanism = 'mechansimFiles/skeletal.inp'
app.inventory.thermo = 'mechansimFiles/therm.dat'
app.inventory.trans = 'mechansimFiles/tran.dat'
...
species_non_qssa = getListSpecies('mechansimFiles/qssa_list.txt')
...
#        # already starts at 0 !! 
#        print('nQSSspecies = ',self.nQSSspecies)
#        if (self.nQSSspecies > 0):
