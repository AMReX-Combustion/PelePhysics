...
amrex::Array<std::string,3> CKSYMS_STR()
{
    amrex::Array<std::string,3> result;
    result[0] = "NC10H22";
    result[1] = "O2";
    result[2] = "N2";
    return result;
...
AMREX_GPU_HOST_DEVICE void CKCVMS(double *  T,  double *  cvms)
{
    ...
    cvms[0] *= 5.843451592679435e+05; /*NC10H22 */
...
AMREX_GPU_HOST_DEVICE void CKCPMS(double *  T,  double *  cpms)
{
    ...
    cp_R(cpms, tc);
    /*multiply by R/molecularweight */
    cpms[0] *= 5.843451592679435e+05; /*NC10H22 */
...
void CKSMS(double *  T,  double *  sms)
{
    ...
    /*multiply by R/molecularweight */
    sms[0] *= 5.843451592679435e+05; /*NC10H22 */
