...
.. table::
   ...
   |               |                 |                 |                 |                 |[m/s]            |                 |
   +===============+=================+-================+=================+=================+=================+=================+
   |``Tonini_4_33``|1000             |1                |300              |200              |6.786            |[#ton]_ Fig 4.33 |
   +---------------+-----------------+-----------------+-----------------+-----------------+-----------------+-----------------+
...
.. [#daif] "Comparison of multicomponent fuel droplet vaporization experiments in forced convection with the Sirignano model", A. Da\"{\i}f and M. Bouaziz and X. Chesneau and A. Ali Ch{\'e}rif, Exp. Therm. Fluid Sci., Vol. 18, No. 4, pp. 282-290, Issn 0894-1777 (1998)
