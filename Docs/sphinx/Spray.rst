...
.. table::
   ...
   +-------------------------------+---------------------+---------------------------+--------------------+
   |``initial_injection_flow_time``|The fluid time at which injection should start   |Yes                 |
   +-------------------------------+---------------------+---------------------------+--------------------+
   |``trans_matrix``               |Coordinate transformation matrix                 |No                  |
   |                               |Direction cosine matrix in case                  |                    |
   |                               |the Fluent and Pele Coordinates                  |                    |
   |                               |are different                                    |                    |   
   +-------------------------------+----------------------+--------------------------+--------------------+
   |``translation``                |Translation provided to DPM coordinates to       |No                  |
   |                               |align to Pele coordinate system                  |                    |   
   +-------------------------------+----------------------+--------------------------+--------------------+
   |``is_dpm_periodic``            |Boolean. If true, repeats the spray injection    |Yes                 |
