...
gas1 = ct.Solution('mechanism/C2H4_2011.cti')
gas1.TPX = 800.0, 1.4*ct.one_atm, 'O2: 0.20153, C2H4: 0.040307, N2: 0.75816'
...
io.writeMultiColFile('output/CanteraReaction_C2H4_2011.txt','',timeTemp)
