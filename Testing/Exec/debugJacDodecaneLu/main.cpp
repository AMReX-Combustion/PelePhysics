...
main(int argc, char* argv[])
{
    ...
    amrex::Real * conv_consP = new amrex::Real [NUM_PERT-1];
    amrex::Real * error_noconsP = new amrex::Real [NUM_PERT];
    amrex::Real * conv_noconsP = new amrex::Real [NUM_PERT-1];
    ...
    for (int i=0; i < NUM_PERT-1; ++i){
        conv_consP[i] = error_consP[i+1]/error_consP[i];
        conv_noconsP[i] = error_noconsP[i+1]/error_noconsP[i];
    } 

    print<double>(error_consP,NUM_PERT,"error_consP");
    print<double>(error_noconsP,NUM_PERT,"error_noconsP");
    print<double>(conv_consP,NUM_PERT-1,"conv_consP");
    print<double>(conv_noconsP,NUM_PERT-1,"conv_noconsP");
