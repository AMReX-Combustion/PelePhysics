...
static int Alloc(SUNMemoryHelper helper, SUNMemory* memptr,
...
static int Dealloc(SUNMemoryHelper helper, SUNMemory mem)
{
...
static SUNMemoryHelper CloneMemoryHelper(SUNMemoryHelper helper)
{
  return *The_SUNMemory_Helper();
}

static int DestroyMemoryHelper(SUNMemoryHelper helper)
{
  return(0);
}

static SUNMemoryHelper CreateMemoryHelper()
{
