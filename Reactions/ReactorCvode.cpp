...
#if defined(AMREX_USE_CUDA) && !defined(PELE_USE_CYORDER)
...
#if defined(PELE_USE_MAGMA) && !defined(PELE_USE_CYORDER)
    a_LS =
...
#if defined(PELE_USE_KLU) && !defined(PELE_USE_CYORDER)
